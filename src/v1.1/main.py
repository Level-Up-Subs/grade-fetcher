...
for index, message in enumerate(messages):
    ...
    for identifier in cert_identifiers:
        # print(identifier)
        cert_url = f'https://api.psacard.com/publicapi/cert/GetByCertNumber/{identifier}'
        ...
        if data == 'Certificate Number Not Found':
            # If certificate number not found, only insert cert number
            #cert_number = data.get('PSACert', {}).get('CertNumber', 'Certificate Number Not Found')
            # Insert cert number with no additional info
            html_table += f"""
            <tr>
            <td>{identifier}</td>
            <td>N/A</td>
            ...
            # Extract data for HTML table
            cert_number = data['PSACert']['CertNumber']
            card_grade = data['PSACert']['CardGrade']
            description = f"{data['PSACert']['Year']} {data['PSACert']['Brand']} {data['PSACert']['CardNumber']} {data['PSACert']['Subject']}"
